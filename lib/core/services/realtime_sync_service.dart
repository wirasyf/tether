...
class RealtimeSyncService {
  ...
  final StreamController<bool> _partnerStatusController =
  ...
  void _handleIncomingTouch(DatabaseEvent event) {
    try {
      ...
      // Convert to Map<String, dynamic> properly for web
      Map<String, dynamic> data;
      if (snapshotValue is Map) {
        data = Map<String, dynamic>.from(snapshotValue);
      } else {
        debugPrint('Unexpected touch data type: ${snapshotValue.runtimeType}');
        return;
      }
      ...
      final touch = TouchEvent.fromJson(data);
  ...
  void _handleIncomingGesture(DatabaseEvent event) {
    try {
      ...
      if (snapshotValue is Map) {
        ...
        debugPrint(
          'Unexpected gesture data type: ${snapshotValue.runtimeType}',
        );
        return;
      }
      ...
      final gesture = GestureEvent.fromJson(data);
